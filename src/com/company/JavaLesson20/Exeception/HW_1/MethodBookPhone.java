...
public class MethodBookPhone {
    ...
    public void addNewContact() {
        ...
        while (true) {
            ...
            if (nameAdd.isEmpty()) {
                try {                                                                        // try - catch
                    throw new NullPointerException("You enter line is empty!!!");
                ...
                for (int i = 0; i < arrayPerson.length; i++) {
                    if (arrayPerson[i].getName() == null) {
                        ...
                        arrayPerson = Arrays.copyOf(arrayPerson, arrayPerson.length + 5);
        ...
        while (true) {
            ...
            if (answer.equalsIgnoreCase("no")) {
                ...
                if (result) {
                    ...
                    try {                                                                   //try-catch
                        ...
                        throw new IllegalArgumentException("Phone's number is not valid :( ");
            ...
            try {                                                                                //try-catch
                throw new IllegalArgumentException("You enter incorrect answer!!!");
            } catch (IllegalArgumentException e) {
                e.getMessage();
                e.printStackTrace();
            }
        ...
        while (true) {
            ...
            for (int i = 0; i < arrayPerson.length; i++) {
                ...
                for (int j = 0; j < searchChar.length; j++) {
                    if (i == arrayPerson.length - 1 && searchChar[j] != arrayChar[j]) {
                        System.err.println("This person not be!!!");
                        break;
                    } else if (searchChar[j] != arrayChar[j]) {
                        break;
            ...
            System.out.println("Do you want go up in menu? Yes/No");
